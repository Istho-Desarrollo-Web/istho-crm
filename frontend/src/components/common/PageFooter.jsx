...
const PageFooter = ({ className = '' }) => (
  ...
  >
    <div className="flex items-center gap-2">
      <img src={logoIstho} alt="ISTHO" className="h-6 w-auto max-w-[72px] object-contain drop-shadow-[0_2px_6px_rgba(0,0,0,0.30)] dark:drop-shadow-none dark:brightness-0 dark:invert" />

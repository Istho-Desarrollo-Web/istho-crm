...
const EntradasList = () => {
  ...
  const handleView = (entrada) => {
    navigate(`/operaciones/entradas/${entrada.id}`);
  };
  ...
  const handleExportExcel = async () => {
    try {
      ...
      const url = `${baseUrl}/auditorias/entradas/excel?${params.toString()}`;
      await descargarArchivo(url, `entradas-inventario-${fechaDescarga()}.xlsx`);
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-700 animate-fadeIn">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-slate-600 bg-slate-50 dark:bg-centhrix-surface text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400"
                  />
                </div>
                {/* Fecha hasta */}
                <div>
                ...
                {!esPortal && (
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 text-sm rounded-xl border border-gray-200 dark:border-slate-600 bg-slate-50 dark:bg-centhrix-surface text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 disabled:opacity-50"
                    >
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white transition-colors"
                >

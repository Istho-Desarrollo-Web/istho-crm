          ...
          <div className="flex items-center gap-2">
            <div className="relative group">
              <button
                ...
                className="p-2.5 rounded-xl bg-white dark:bg-centhrix-card text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-centhrix-surface hover:border-slate-300 dark:hover:border-slate-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 transition-all duration-200"
              >
                <Eye className="w-5 h-5" />
              </button>
              <span className="pointer-events-none absolute top-full left-1/2 mt-2 -translate-x-1/2 rounded-lg bg-slate-800 dark:bg-slate-700 px-2.5 py-1 text-xs text-white whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity z-50">
                Vista Previa
              </span>
            </div>
            ...
            <div className="relative group">
              <button
                ...
                onClick={handleSave}
                disabled={saving}
                aria-label={isEdit ? 'Guardar Cambios' : 'Crear Plantilla'}
                aria-busy={saving || undefined}
                className="p-2.5 rounded-xl bg-orange-500 text-white hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
                {saving ? (

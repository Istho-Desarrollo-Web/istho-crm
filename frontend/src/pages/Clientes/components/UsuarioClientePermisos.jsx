...
const ModuloPermisos = ({ moduloKey, modulo, permisos, onChange, expanded, onToggleExpand }) => {
    ...
    <div className="border border-gray-100 dark:border-slate-700 rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className={`w-10 h-10 rounded-xl flex items-center justify-center ${colorClasses[modulo.color]}`}
          >
          ...
          {modulo.permisos.map((permiso) => {
            ...
            return (
              ...
              >
                ...
                <PermisoIcon
                  className={`w-4 h-4 ${activo ? 'text-emerald-600' : 'text-slate-400'}`}
                />

                <div className="flex-1">
                  <p
                    className={`text-sm font-medium ${activo ? 'text-slate-800 dark:text-slate-100' : 'text-slate-600 dark:text-slate-300'}`}
                  >
                    {permiso.nombre}
                  </p>
...
const UsuarioClientePermisos = ({ isOpen, onClose, onSubmit, usuario = null }) => {
      ...
      <div className="space-y-5">
          ...
          <div className="text-right">
            ...
            <p
              className={`text-xl font-bold ${
                permisosActivos === totalPermisos
                  ? 'text-emerald-600'
                  : permisosActivos > totalPermisos / 2
                    ? 'text-amber-600'
                    : 'text-slate-600'
              }`}
            >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" onClick={handleActivarTodos}>
              Activar todos
            </Button>
          </div>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-amber-700 dark:text-amber-300">
              ...
              <p className="mt-1 text-amber-600 dark:text-amber-400">
                Los cambios en los permisos se aplicarán inmediatamente. El usuario verá los cambios
                en su próxima carga de página.
              </p>
            </div>
          </div>
        </div>

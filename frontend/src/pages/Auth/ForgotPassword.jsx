...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                setSubmitted(true);
                enqueueSnackbar('Si el correo existe, recibiras instrucciones para restablecer tu contrasena', { variant: 'success' });
            } else {
            ...
            <>
                ...
                <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#E74C3C] via-[#FF6B5A] to-[#F39C12] dark:from-[#0F1023] dark:via-[#151631] dark:to-[#1A1B3A] relative overflow-hidden">
                    ...
                    >
                        ...
                        >
                            Si el correo <strong className="text-gray-700 dark:text-slate-300">{email}</strong> esta registrado en nuestro sistema, recibiras un enlace para restablecer tu contrasena.
                        </p>

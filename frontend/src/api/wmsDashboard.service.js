...
const wmsDashboardService = {
  getStatus: () => apiClient.get(WMS_DASHBOARD_ENDPOINTS.STATUS),

  getEstadisticas: () => apiClient.get(WMS_DASHBOARD_ENDPOINTS.ESTADISTICAS),

  getHistorial: (params = {}) => apiClient.get(WMS_DASHBOARD_ENDPOINTS.HISTORIAL, { params }),
